  ...
  useEffect(() => {
    if (isSuccessDialogOpen) {
      Alert.alert(
        "Logged Out!",
        "See you soon!",
        [{ text: "Bye!", onPress: handleSuccessOK }],
        { cancelable: false },
      );
    }
  }, [isSuccessDialogOpen]);
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }} edges={["top"]}>
      <View style={{ flex: 1 }}>
        ...
        {/* More Info Modal */}
        <Modal
          visible={isMoreInfoOpen}
          transparent
          onRequestClose={() => setIsMoreInfoOpen(false)}
        >
          <TouchableOpacity
            style={styles.modalOverlay}
            onPress={() => setIsMoreInfoOpen(false)}
          />
          <View style={styles.moreInfoMenu}>
            ...
            <ThemedText type="default">
              Biometrics Added: {biometricCreatedAt || "Unavailable"}
            </ThemedText>
            <ThemedText type="default">
              Biometrics Last Updated: {biometricLastUpdated || "Unavailable"}
            </ThemedText>
          </View>
        </Modal>
        ...
        >
          ...
          <View style={styles.settingsMenu}>
            ...
            >
              ...
              <ThemedText
                type="default"
                style={[styles.menuItemText, { color: "#A31621" }]}
              >
                Logout
              </ThemedText>
              {isLoggingOut && (
