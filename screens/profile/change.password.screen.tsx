...
export default function ChangePasswordScreen() {
     ...
     const handleSubmit = () => {
          ...
          Alert.alert(
               ...
               "This will update your password. This action cannot be undone.",
               [
          ...
          <SafeAreaView style={{ flex: 1 }}>
               ...
               >
                    ...
                    <ThemedText style={styles.description}>
                         Enter your old password and a new one to update it. New passwords must be
                         at least 8 characters.
                    </ThemedText>
                    <ThemedText style={styles.description}>
                         Before you begin, It is a good idea to prepare your new password ahead of
                         time and save it somewhere safe, like a password manager. That way, you
                         won’t risk losing access if you forget it later.
                    </ThemedText>
