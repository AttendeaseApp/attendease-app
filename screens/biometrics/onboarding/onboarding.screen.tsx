...
const PAGES = [
    ...
    },
    {
        ...
        description: "This is a one-time setup to keep you verified during event registrations. Please ensure you are in a well-lit area.",
    },
];
        ...
        <View style={styles.container}>
                ...
                <View style={styles.page}>
                    ...
                    {currentIndex === 1 && (
                        <View style={styles.checkboxWrapper}>
                            <Checkbox isChecked={termsAccepted} onChange={setTermsAccepted} value="sm">
                                <CheckboxIndicator>
                                    <CheckboxIcon as={CheckIcon} />
                                </CheckboxIndicator>
                                <CheckboxLabel>
                                    <ThemedText type="default">
                                        I have read and agree to the Terms & Privacy Policy, and I consent to the collection of my facial biometrics for verification purposes.
                                    </ThemedText>
                                </CheckboxLabel>
                            </Checkbox>
                        </View>
            ...
            <View style={styles.footer}>
                <View style={styles.buttonRow}>
                    {currentIndex > 0 && (
                        <Button action="secondary" onPress={handleBack} style={styles.backButton}>
                    ...
                    <Button
                        ...
                        style={[currentIndex === 0 ? styles.fullWidthButton : styles.nextButton, currentIndex === 1 && !termsAccepted && styles.disabledButton]}
                    >
                        <ButtonText>{currentIndex === TOTAL_STEPS - 1 ? "Continue" : "Next"}</ButtonText>
                    </Button>
                </View>
            </View>
        </View>
