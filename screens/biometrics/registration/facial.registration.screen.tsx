...
export default function OneTimeFacialRegistrationScreen() {
    ...
    const showAlert = useCallback((title: string, message: string, actions: typeof alertActions = [{ label: "OK" }]) => {
        setAlertTitle(title);
    ...
    }, [isProcessing, capturedImages.length, REQUIRED_IMAGES, pulseAnim]);
    ...
    }, [capturedImages.length, REQUIRED_IMAGES, progressAnim]);
