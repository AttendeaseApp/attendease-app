...
export default function EventRegistrationFacialVerificationScreen() {
  ...
  const { latitude, longitude, locationLoading } =
  ...
  if (!permission.granted) {
    return (
      <View style={facialVerificationScreenStyles.center}>
        <ThemedText
          type="default"
          style={facialVerificationScreenStyles.permissionText}
        >
          Camera access is required to verify your identity. This is essential
          for secure event registration.
        </ThemedText>
        ...
        <View style={facialVerificationScreenStyles.overlay}>
          <View style={facialVerificationScreenStyles.instructionBox}>
            <ThemedText type="defaultSemiBold" colorVariant="white">
              Align your face inside the frame and tap the button to verify your
              identity.
            </ThemedText>
          </View>
